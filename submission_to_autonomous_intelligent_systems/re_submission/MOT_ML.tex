...
\end{equation}
\noindent
\red{Then, all scalars} obtained per timestamp are summarized and divided by the number of samples $N$ of a minibatch for the cost function:
\begin{equation}
...
\begin{figure}[t!]
	\centerline{\includegraphics[width=0.9\linewidth]{spent_rmse.pdf}}
...
\begin{figure}[t]
	\centerline{\includegraphics[width=0.9\linewidth]{data_association_results.pdf}}
