...
The architecture concludes with a Fully Connected (FC) layer, which integrates insights from previous layers, with its dimensionality aligned to the number of required output variables {\cite{DL_FC.2010}}. \hl{Note, that the measurement equation -- Inhalt fehlt noch}
